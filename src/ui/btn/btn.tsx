...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(function ButtonRef({children, ...props}, ref) {
    return (
...
const A = forwardRef<HTMLAnchorElement, LinkProps>(function ARef({children, ...props}, ref) {
    return (
        <a ref={ref} {...props}>
            {children}
        </a>
...
const Btn = forwardRef<HTMLButtonElement | HTMLAnchorElement, LinkProps | ButtonProps>(function BtnRef(
    {className, children, href, isWhite, ...props},
    ref
) {
